...
class TavilyPlaceSearchTool:
    ...
    def tavily_search_restaurants(self, place: str):
        return self._run(f"top restaurants and eateries in {place}")

    def tavily_search_activity(self, place: str):
        return self._run(f"popular activities in and around {place}")

    def tavily_search_transportation(self, place: str):
        return self._run(f"modes of transportation available in {place}")
